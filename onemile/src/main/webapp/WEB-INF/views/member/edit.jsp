...
<form method="post">
	<div class="outer2">
		<div class="wz container form-container" style="width: 500px">
			<h2 class="wz text display2 page-title" style="margin-top: 50px">회원정보 수정</h2>
			...
			<div class="field name-field" style="margin-top: 30px">
				...
				<div class="wz input">
					<input id="nickName" class="input text block large" type="email"
						aria-required="true"
						autocomplete="off" onblur="emailCheck();" value="${memberDTO.email}" readonly>
					<div class="notice"></div>
				</div>
			</div>

			<div class="field name-field">
				<label class="label">닉네임 [${count == 1 ? '멤버십가입하세요' : ''}]</label>
				<div class="wz input">
					<input ${count == 1 ? 'readonly' : ''}  id="nickName" class="input text block large" type="text"
						placeholder="닉네임 입력" name="nick" aria-required="true"
						autocomplete="off" onblur="nickCheck();" value="${memberDTO.nick}" >
					<div class="notice"></div>
				</div>
			</div>
			...
			<div class="field name-field">
				...
				<div class="wz input">
					<input  id="nickName" class="input text block large" type="tel"
						placeholder="-포함 13자리를 입력해주세요." name="phone" 
			...
			<div class="field password-field group" style="margin-top: 70px">
				...
				<textarea name="intro" rows="5" cols="50"
						id="intro" oninput="lengCheck();"
						class="input text block large">${memberDTO.intro}</textarea>
				</div>
			</div>
			<br>
			<input type="submit" id="btnJoin" class="wz button primary block" onclick="formCheck();" value="수정하기">
		</div>
	</div>
</form>
