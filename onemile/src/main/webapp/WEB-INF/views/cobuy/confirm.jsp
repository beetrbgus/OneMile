...
<div class="outer2">
	<div class="wpurchase-wrap" style="width: 700px">
		...
		<form name="purchaseForm" id="purchaseForm" method="post" action="${pageContext.request.contextPath}/cobuy/confirm">
					...
					<div>
						<div class="DefaultFundingPrice_container__1gSin">
							...
							<dl class="DefaultFundingPrice_totalPrice__x2h8J">
								<dt>상품금액</dt>
								<dd>
									<em>${confirmVO.price}</em>원
								</dd>
							</dl>
							<dl class="DefaultFundingPrice_totalPrice__x2h8J">
								<dt>수량</dt>
								<dd>
									<em>${confirmVO.quantity}</em>개
								</dd>
							</dl>
							<dl class="DefaultFundingPrice_totalPrice__x2h8J">
								<dt>최종결제금액</dt>
				...
				<div id="eachTermsNoticeWrap">
					<div class="term-checkbox-wrap">
						<label class="wz checkbox circular"> 
							...
							value="Y" autocomplete="off" required>
