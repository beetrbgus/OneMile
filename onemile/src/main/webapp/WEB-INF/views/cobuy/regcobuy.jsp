...
<div class="page-container">
	...
	<input class="post-title" type="text" name="title" placeholder="공구의 제목을 입력해주세요." required><br><br>
	<select name="middleName" class="category">
		...
		<label class="label">만료기한 : </label><input type="date" class="form-input" id="deadLine" name="deadLine" required><br><br>
		<label class="label">가격 : </label><input type="number" class="num-input" name="price" min="100" required placeholder="원 단위"><label class="label">수량 : </label><input type="number" class="num-input" name="stock" min="0" required placeholder="개 단위"><br><br>
	<hr> 
		<label class="label">상품이름 : </label><input type="text" class="post-title" name="pName" required placeholder="상품명을 입력해주세요."><br><br>
		<label class="label">상품설명 : </label><textarea name="descript" class="post-content" placeholder="상품 정보를 입력해주세요." required></textarea><br><br>
		<label class="label">이미지 : </label><input type="file" class="form-input" name="attach" multiple="multiple"><br>
	<!--  지도 영역 -->
	...
	<input id="location" type="hidden" name="detailAddress" required><br><br>
