...
<div class="container detail">
    <div class="detail-wrapper">
        <div class="detail_info">
            <p class="detail_name">여자들의 로망 폴댄스 체험❤️</p>
            <div class="detail_info_container">
                <div>
                    <div>
                        <p class="sub">장소</p>
                    </div>
                    <p class="detail_startDate">온라인</p>
                </div>
                <div>
                    <div>
                        <p class="socialing_startDate sub">모임일</p>
                    </div>
                    <p class="summary-sub">1.15(토) 오후 3시 0분</p>
                </div>
            </div>
        </div>
                ...
                <div id="detail_main_carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" id="cover_carousel_inner">
                        <div class="carousel-item active"
                            style="background-image:url(https://munto-images.s3.ap-northeast-2.amazonaws.com/production-item/KakaoTalk_Photo_2021-05-03-22-11-44.jpeg)">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="detail_info_mobile">
            ...
            <div class="detail_info__location"><img src="/1_calendar_location_24px.83d0023a.svg"><span>온라인 ・ 1.15(토) 오후
                    3시 0분</span></div>
        </div>
    </div>
    ...
    <div id="introduce_row" class="detail_content_row row">
        ...
        <div class="col-12" id="introduce"> 한번즘 나도 할 수 있을까?? 고민했던 운동중 하나인 폴댄스!!<br>👉등록해서 바로해볼까 하기엔 조금 부담되는데..<br>👉내가 할
            수 있을까??<br>👉 힘이 많이 필요하진 않을까??<br>👉다이어트하고 해봐야지..<br><br>누구나 다 같은생각..🥲 을 하죠!!ㅎㅎㅎㅎ<br>그래서❗️❗️<br>먼저 폴댄스를 하고
            있던중 학원에서 무료체험 이벤트를 진행한다고 하네요!!!<br>워밍업으로 요가, 헬스, 필라테스 동작으로 몸도풀고 <br>폴타면서 근력도 키우고 예쁜동작도 해보고!!<br>예쁜 인생 사진 ,
            영상을 찍을 수 있는 폴댄스!!<br>의상이 없어도 반팔 ,반바지만 있으면 모두가능해요!!!<br>⭐️ 런닝 50분 = 폴댄스 15분⭐️<br>다이어트에도 좋구 처음으로 복근도
            생겼어융ㅎㅎ<br>여러분도 망설이지 마시고 한번 해보세요!!<br><br>무료체험이니 일단 해보세용❤️‍🔥<br>전국에 60개 이상지점이 있어 원하는 위치 말씀해 주시면 시간표 보내드릴게요❤️
        </div>
    </div>
    ...
    <div id="info_row" class="detail_content_row row">
        ...
        <div class="col-12">
            <div class="info_row no_padding row">
                ...
                <div class="col info_people">최소 2명 ~ 최대 9명</div>
            </div>
            <div class="info_row no_padding row">
            ...
            <div class="info_row no_padding row">
                ...
                <div class="col info_datetime">1월 15일 (토) 오후 3시 0분</div>
            </div>
