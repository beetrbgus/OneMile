...
<div class="container detail">
        ...
        <div class="detail_info">
            ...
            <div class="detail_info_container">
                <div>
                    ...
                    <p class="detail_startDate"><input type="text" id="location" name="location" required readonly></p>
                </div>
                <div>
                    <div>
    ...
    <div id="info_row" class="detail_content_row row">
        ...
        <div class="col-12">
            ...
            <div class="info_row no_padding row">
                <div class="col-auto">  </div>
                <div class="col info_datetime">종료일 :
             ...
             <div class="info_row no_padding row">
                ...
                <div class="col info_location">최소인원 :
					<input type="number" name="minpeople" min="2" value="2" required></div>
            </div>
             <div class="info_row no_padding row">
                <div class="col-auto">  </div>
                <div class="col info_location">최대인원 : 
					<input type="number" name="maxpeople" min="2" max="${AD}" value="2" required></div>
            </div>
    ...
    <div id="introduce_row" class="detail_content_row row">
        ...
        <div class="col-12" id="introduce">
       	<textarea name="context" placeholder="모임을 설명해주세요." required cols="50" rows="10" style="resize: none;"></textarea>
        </div>
    </div>
